const en = {
  ...
  campaigns: {
    ...
    subtitle: "Manage WhatsApp marketing campaigns",
    tabs: {
      campaigns: "Campaigns",
      templates: "Templates",
      contacts: "Contacts",
    ...
    status: {
      ...
      waitingApprovalHint: "Template is pending WhatsApp approval",
      SCHEDULED: "Scheduled",
      SENDING: "Sending",
      SENT: "Sent",
      CANCELLED: "Cancelled",
    ...
    create: {
      ...
      phonePlaceholder: "Enter phone in international format e.g. +966...",
      addPhone: "Add",
    ...
    actions: {
      ...
      confirmCancel: "Are you sure you want to cancel this campaign?",
      resend: "Resend",
      confirmResend: "Are you sure you want to resend this campaign to all recipients?",
    },
    table: {
      name: "Campaign Name",
      template: "Template",
    ...
    empty: {
      ...
      message: "Create your first marketing campaign to start reaching your customers",
    },
    contacts: {
      title: "Contacts",
      subtitle: "Customer list from previous conversations",
      phone: "Phone Number",
      name: "Name",
    ...
    toasts: {
      ...
      createdPendingApproval: "Campaign created! Your template has been submitted to WhatsApp for review (usually 5 min – 24 hours). You'll be notified when it's approved.",
      ...
      templateApproved: "Template has been approved!",
      templateRejected: "Template has been rejected",
    },
    errors: {
      requiredFields: "Please fill in all required fields",
      noApprovedTemplate: "No approved templates. Please submit a template for approval first",
    ...
    submitForm: {
      dialogTitle: "Submit Template for Approval",
      bodyTitle: "Template Body",
      typeLabel: "Template Type",
      typeHelp: "Choose the template type that matches the WhatsApp message you want to send",
      mediaUrls: "Media URLs",
      add: "Add",
      actionButtons: "Action Buttons",
      button: "Button",
      quickReplyButtons: "Quick Reply Buttons",
      quickReplyLimit: "Max 10 buttons, 20 chars each",
      ...
      card: "Card",
      catalogId: "Catalog ID (from Meta Commerce Manager)",
      catalogTitle: "Catalog Title",
      catalogItems: "Catalog Items",
      item: "Item",
      buttonTitlePlaceholder: "Button title (max 20 chars)",
      buttonLabel: "Button {index} (max 20 chars)",
      cardTitlePlaceholder: "Card title",
      cardBodyPlaceholder: "Card body (max 160 chars)",
      imageUrlPlaceholder: "Image URL",
      catalogTitlePlaceholder: "Title (max 60 chars)",
      productIdPlaceholder: "Product ID",
      sectionTitlePlaceholder: "Section title",
      phone: "Phone",
      copyCode: "Copy Code",
      url: "URL",
      buttonsLabel: "Buttons (1-2 per card):",
    ...
    usage: {
      title: "Usage & Quota",
      subtitle: "Monitor your conversation limits and active sessions",
      actions: {
        refresh: "Refresh Metrics",
        retry: "Retry Now",
        upgrade: "Upgrade",
      },
      loading: "Calculating usage metrics...",
      error: {
      ...
      cards: {
        volume: {
          ...
          remaining: "{count} Conversations Remaining",
          unlimited: "Unlimited Enterprise Plan",
          unlimitedDesc: "Your account is on an unlimited plan with no monthly conversation restrictions.",
          approaching: "Approaching Monthly Limit",
          approachingDesc: "You've consumed {percent}% of your allowance. Consider a top-up to avoid service interruption.",
        },
        quota: {
          title: "Quota Allocation",
          planLimit: "Plan Base Limit",
        ...
        daily: {
          ...
          description: "Recent activity breakdown by day",
          date: "DATE",
        ...
        sessions: {
          ...
          description: "The last 20 active 24-hour interaction windows",
        ...
        history: {
          title: "Grant History",
          description: "Manual top-ups this cycle",
        },
        info: {
          title: "Understanding Conversation Quotas",
          desc1: "Usage is tracked based on",
          desc1Highlight: "unique 24-hour sessions",
          desc1End: ". A conversation is counted only when a customer interacts with your bot.",
          desc2: "Multiple messages within the same session window are consolidated. This allows for rich customer engagement without depleting your quota.",
          proTip: "Pro Tip: Your top-up of {count} messages is valid until the end of this billing cycle.",
          button: "Detailed Usage Guide",
        },
        context: {
